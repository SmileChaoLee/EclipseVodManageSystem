 ...
 * @author chaolee
 */
@WebServlet(name = "SongLastPageServlet", urlPatterns = {"/songController/SongLastPageServlet"})
public class SongLastPageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("SongLastPageServlet->doGet() ....");
        ...
        int pageNo = songTable.getTotalPageOfQuery(songAttr.getQueryCondition());
